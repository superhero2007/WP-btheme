	...
	function sc_blog_slider( $attr, $content = null )
	{
		...
		$output = '<div class="blog_slider clearfix '. $classes .'">';
			...
			$output .= '<div class="blog_slider_header">';
				...
				$output .= '<a class="image_special_left button button_js slider_prev " href="#" style="background-color: transparent !important;"></a>';
				$output .= '<a class="image_special_right button button_js slider_next " href="#" style="background-color: transparent !important;"></a>';
			$output .= '</div>';
			...
			$output .= '<ul class="blog_slider_ul">';				
				while ( $query_blog->have_posts() ){
					...
					$output .= '<li class=" image-special-border '. implode(' ',get_post_class()).'">';
						$output .= '<div class="item_wrapper image_special_slide">';
							...
							if( get_post_format() == 'quote'){
								...
								$output .= '<div class="image_frame scale-with-grid">';
									$output .= '<div class="image_wrapper">';
										$output .= '<a href="'. get_permalink() .'">';
											$output .= get_the_post_thumbnail( get_the_ID(), $thumb_size, array('class'=>'scale-with-grid image-special-setting-height' ) );
										$output .= '</a>';
									$output .= '</div>';
								$output .= '</div>';	
							}
							...
							$output .= '<div class="desc">';
								if( get_post_format() != 'quote') $output .= '<h4 style="line-height:1; height:7vh; padding:10px;"><a href="'. get_permalink() .'" class="image_special_title">'. get_the_title() .'</a></h4>';
								$output .= '<p class="image_special_text">'. substr($description, 0, strpos($description,' ',60))." ..." .'</p>';
								$output .= '<a href="'. get_permalink() .'" class="button_label image_readmore_button"> Read More </a>';
								$output .= '<a href="'. get_permalink() .'" class="button button_left button_js" style="display:none !important;"><span class="button_icon"><i class="icon-layout"></i></span><span class="button_label">'. $translate['readmore'] .'</span></a>';
							$output .= '</div>';
