...
if( ! function_exists( 'mfn_styles' ) )
{
	function mfn_styles() 
	{
		...
		// Google Font for counters etc. 	| @depricated since 10.5, replaced with Theme Options / Font / Decorative
...
// 			wp_enqueue_script( 'jquery-mfn-parallax', 	THEME_URI. '/js/parallax/parallax.js', false, THEME_VERSION, true );
