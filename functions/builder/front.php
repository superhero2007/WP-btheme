...
// 				if( $section['attr']['bg_image'] ){
// 					echo '<div class="section mcb-section parallax '. $section_class .'" style="padding:350px 0;">'; // 100%
// 					echo '<img class="mfn-parallax" src="'. $section['attr']['bg_image'] .'" alt="parallax background"/>';
// 				} else {
// 					echo '<div class="section mcb-section '. $section_class .'" style="padding:50px 0;">'; // 100%
// 				}
