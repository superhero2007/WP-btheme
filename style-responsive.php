...
<?php if( mfn_opts_get('responsive') ): ?>
	...
	@media only screen and (min-width: <?php echo $mobileMenuInitW; ?>px) 
	{
		...
		.header-simple #Header a:hover.responsive-menu-toggle { text-decoration: none; }
			...
			.header-simple #Top_bar #menu ul li.submenu .menu-toggle { width:48px; height:48px; display:block; position:absolute; right:0; top:0; border-left:1px solid rgba(0,0,0,0.03); background:url(<?php echo THEME_URI; ?>/images/menu-plus.png) center no-repeat;}
	...
	@media only screen and (max-width: <?php echo $mobileMenuInitW - 1; ?>px)
	{
		...
		#Top_bar #menu ul li.submenu .menu-toggle { width:48px; height:48px; display:block; position:absolute; right:0; top:0; border-left:1px solid rgba(0,0,0,0.03); background:url(<?php echo THEME_URI; ?>/images/menu-plus.png) center no-repeat;}
